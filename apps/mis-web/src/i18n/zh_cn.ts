  ...
  page: {
    ...
    admin: {
      ...
      systemDebug: {
        ...
        syncUsersToCluster: {
          title: "同步账号和用户到集群",
          alertInfo: "当新增集群到多集群环境时，可以使用此功能将SCOW数据库中的所有账号和用户同步到新集群。",
          targetCluster: "目标集群",
          selectTargetCluster: "选择要同步到的目标集群",
          confirmSync: "确认同步",
          confirmSyncMessage: "确认要将所有账号和用户同步到集群 {} 吗？",
          syncing: "正在同步...",
          syncSuccess: "同步完成",
          syncSuccessMessage: "成功同步 {} 个账号和 {} 个用户到集群 {}",
          syncFailed: "同步失败",
          partialSyncWarning: "部分同步失败",
          failedAccounts: "失败的账号",
          failedUsers: "失败的用户",
          noActivatedCluster: "没有可用的激活集群",
          syncButton: "立即同步",
        },
      },
      resourceManagement: {
