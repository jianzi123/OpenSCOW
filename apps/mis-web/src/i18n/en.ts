  ...
  layouts: {
    route: {
      ...
      platformManagement: {
        ...
        userSynchronization: "User Synchronization",
  ...
  page: {
    ...
    admin: {
      ...
      systemDebug: {
        ...
        syncUsersToCluster: {
          title: "Sync Accounts and Users to Cluster",
          alertInfo: "When adding a new cluster to the multi-cluster environment, "
          + "you can use this feature to synchronize all accounts and users from SCOW database to the new cluster.",
          targetCluster: "Target Cluster",
          selectTargetCluster: "Select the target cluster to sync to",
          confirmSync: "Confirm Sync",
          confirmSyncMessage: "Are you sure you want to sync all accounts and users to cluster {}?",
          syncing: "Syncing...",
          syncSuccess: "Sync Completed",
          syncSuccessMessage: "Successfully synced {} accounts and {} users to cluster {}",
          syncFailed: "Sync Failed",
          partialSyncWarning: "Partial Sync Failed",
          failedAccounts: "Failed Accounts",
          failedUsers: "Failed Users",
          noActivatedCluster: "No activated clusters available",
          syncButton: "Sync Now",
        },
      },
      resourceManagement: {
        ...
        partitionManagement: {
          ...
          loading: "Loading...",
          loadFailed: "Failed to load partition information",
          noData: "No partition data available",
        },
      },
      finance: {
        pay: {
